...
let simplifiedChinese = {
  ...
  notDisturb: "勿扰模式",
  notDisturbPrompt:
    "开启勿扰模式后，计算机在游戏、应用全屏模式下不会弹出 Wstart 窗口。",
  ...
  cover: "封面",
  noImage: "无图片",
  saveBackgroundImage: "保存背景图",
  saveBackgroundImageToWstart: "保存到wstart目录",
  saveBackgroundImageToProject: "保存到项目目录",
  title: "标题",
  top: "顶部",
...
let traditionalChinese = {
  ...
  notDisturb: "勿擾模式",
  notDisturbPrompt:
    "開啟勿擾模式後，計算機在遊戲、應用全屏模式下不會彈出 Wstart 窗口。",
  notFoundFile: "找不到指定的文件",
  ...
  cover: "封面",
  noImage: "無圖片",
  saveBackgroundImage: "保存背景圖",
  saveBackgroundImageToWstart: "保存到wstart目錄",
  saveBackgroundImageToProject: "保存到項目目錄",
  title: "標題",
  top: "頂部",
...
let english = {
  ...
  openAfterHideMainInterface: "Hide Main Interface After Opening",
  ...
  notDisturbPrompt:
    "After enabling Do Not Disturb mode, Wstart will not pop up during full-screen games or applications.",
  ...
  cover: "Cover",
  noImage: "No Image",
  saveBackgroundImage: "Save Background Image Locally",
  saveBackgroundImageToWstart: "Save to wstart directory",
  saveBackgroundImageToProject: "Save to project directory",
  title: "Title",
  top: "Top",
