...
function newItemData({
  ...
  saveBackgroundImage = false,
  saveBackgroundImageOption = 1,
  ...
  saveBackgroundImage?: boolean | null;
  saveBackgroundImageOption?: 0 | 1 | 2 | null;
  localBackgroundImage?: string | null;
  projectBackgroundImage?: string | null;
}): ItemData {
  // 处理旧数据兼容，将saveBackgroundImage转换为saveBackgroundImageOption
  let option: 0 | 1 | 2 = saveBackgroundImageOption ?? 1;
  if (option === 0) {
    // 兼容旧版本，旧版本的false对应0
    option = saveBackgroundImage ? 1 : 0;
  }
  ...
  return {
    ...
    saveBackgroundImageOption: option,
    localBackgroundImage: localBackgroundImage ?? null,
    projectBackgroundImage: projectBackgroundImage ?? null,
  };
}
