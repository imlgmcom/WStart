## 问题分析
错误信息显示：
- 当前Electron需要NODE_MODULE_VERSION 119
- 但编译的better_sqlite3.node模块使用了NODE_MODULE_VERSION 108
...
2. **自定义rebuild.js脚本**：
   ...
   - 确保原生模块使用正确的NODE_MODULE_VERSION 119
...
## 预期效果
- 原生模块使用Electron 28.3.3的NODE_MODULE_VERSION 119编译
